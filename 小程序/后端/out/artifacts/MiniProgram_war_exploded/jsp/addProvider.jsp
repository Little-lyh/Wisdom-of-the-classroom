        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    ...
                    <form role="form" action="${pageContext.request.contextPath }/ManagePersonAction_addProvider" method="post" class="registration-form" >

                        <fieldset>
                            <div class="form-top">
                                <div class="form-top-left">
                                    <p style="font-size: 20px"><strong>请继续填写填写提供者相关信息:</strong></p>
                                </div>
                            ...
                            <div class="form-bottom">
                                ...
                                <div class="form-group">
                                    <label class="sr-only" for="form-last-name">email</label>
                                    <input type="text" name="ZIP" placeholder="ZIP码..." class="form-last-name form-control">
                                </div>
                                <div class="form-group">
                                    <label class="sr-only" for="form-last-name">email</label>
                                    <input type="text" name="account" placeholder="银行账号..." class="form-last-name form-control" id="form-last-name">
                                </div>
