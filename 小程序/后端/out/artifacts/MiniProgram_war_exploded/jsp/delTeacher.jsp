    ...
    <script>
        ...
        function del(){
            ...
            if(num==""){
                ...
                document.form1.action="${pageContext.request.contextPath }/ManagePersonAction_delProvider";
        ...
        function insert(){
            ...
            if(num==""){
                ...
                document.form1.action="${pageContext.request.contextPath }/ManagePersonDispatcherAction_addProvider";
                document.form1.submit();
            }
        }
        function update(){
            ...
            if(num==""){
                ...
                document.form1.action="${pageContext.request.contextPath }/ManagePersonDispatcherAction_updateProvider";
                document.form1.submit();
            }
        }
    </script>
                        ...
                        <fieldset>
                            <div class="form-top">
                                <div class="form-top-left">
                                    <p style="font-size: 20px"><strong>请填写要管理的提供者号:</strong></p>
                                </div>
                            ...
                            <div class="form-bottom">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="number" placeholder="提供者号码..." class="form-first-name form-control" id="form-first-name">
                                </div>
                                <div class="form-group">
